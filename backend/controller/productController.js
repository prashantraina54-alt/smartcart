...
export const addProduct = async (req, res) => {
    try {
        ...
        // Validate files (your code was assuming all exist — bad assumption)
        if (
            !req.files ||
            !req.files.image1 ||
            !req.files.image2 ||
        ...
        let productData = {
            ...
            // IMPORTANT: assuming cloudinary returns object
            image1: image1?.secure_url || image1,
            image2: image2?.secure_url || image2,
            image3: image3?.secure_url || image3,
            image4: image4?.secure_url || image4
        }
